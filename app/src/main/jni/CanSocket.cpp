...
static int sys(const char *cmdstring) {
    pid_t pid;
    int status;
...
JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1openSocketRAW
        (JNIEnv *env, jclass obj) {
    return newCanSocket(env, SOCK_RAW, CAN_RAW);
}


JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1openSocketBCM
        (JNIEnv *env, jclass obj) {
    return newCanSocket(env, SOCK_DGRAM, CAN_BCM);
}

JNIEXPORT void JNICALL Java_ru_test_testjni_CanSocket__1close
...
JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1discoverInterfaceIndex
...
JNIEXPORT jstring JNICALL Java_ru_test_testjni_CanSocket__1discoverInterfaceName
...
JNIEXPORT void JNICALL Java_ru_test_testjni_CanSocket__1bindToSocket
...
JNIEXPORT void JNICALL Java_ru_test_testjni_CanSocket__1sendFrame
...
JNIEXPORT jobject JNICALL Java_ru_test_testjni_CanSocket__1recvFrame
        (JNIEnv *env, jclass obj, jint fd) {
    const int flags = 0;
    ssize_t nbytes;
    struct sockaddr_can addr;
    ...
    const jclass can_frame_clazz = env->FindClass("ru/test/testjni/"
                                                  "CanSocket$CanFrame");
 ...
 */
JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1fetchInterfaceMtu
...
JNIEXPORT void JNICALL Java_ru_test_testjni_CanSocket__1setsockopt
...
JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1getsockopt
...
//JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1fetch_1CAN_1MTU
JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1fetch_1CAN_1MTU
        (JNIEnv *env, jclass obj) {
    /**
     * struct can_frame {
...
JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1fetch_1CAN_1FD_1MTU
        (JNIEnv *env, jclass obj) {
    /**
     * struct canfd_frame {
     *         canid_t can_id;  // 32 bit CAN_ID + EFF/RTR/ERR flags
...
/*** ioctls ***/
JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1fetch_1CAN_1RAW_1FILTER
        (JNIEnv *env, jclass obj) {
    return CAN_RAW_FILTER;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1fetch_1CAN_1RAW_1ERR_1FILTER
        (JNIEnv *env, jclass obj) {
    return CAN_RAW_ERR_FILTER;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1fetch_1CAN_1RAW_1LOOPBACK
        (JNIEnv *env, jclass obj) {
    return CAN_RAW_LOOPBACK;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1fetch_1CAN_1RAW_1RECV_1OWN_1MSGS
        (JNIEnv *env, jclass obj) {
    return CAN_RAW_RECV_OWN_MSGS;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1fetch_1CAN_1RAW_1FD_1FRAMES
        (JNIEnv *env, jclass obj) {
...
JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1getCANID_1SFF
        (JNIEnv *env, jclass obj, jint canid) {
    // SFF: standard Frame Format
    return canid & CAN_SFF_MASK;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1getCANID_1EFF
        (JNIEnv *env, jclass obj, jint canid) {
    // SFF: extern Frame Format
    return canid & CAN_EFF_MASK;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1getCANID_1ERR
        (JNIEnv *env, jclass obj, jint canid) {
    // error
    return canid & CAN_ERR_MASK;
}

JNIEXPORT jboolean JNICALL Java_ru_test_testjni_CanSocket__1isSetEFFSFF
        (JNIEnv *env, jclass obj, jint canid) {
    return (canid & CAN_EFF_FLAG) != 0 ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL Java_ru_test_testjni_CanSocket__1isSetRTR
        (JNIEnv *env, jclass obj, jint canid) {
    return (canid & CAN_RTR_FLAG) != 0 ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL Java_ru_test_testjni_CanSocket__1isSetERR
        (JNIEnv *env, jclass obj, jint canid) {
    return (canid & CAN_ERR_FLAG) != 0 ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1setEFFSFF
        (JNIEnv *env, jclass obj, jint canid) {
    return canid | CAN_EFF_FLAG;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1setRTR
        (JNIEnv *env, jclass obj, jint canid) {
    return canid | CAN_RTR_FLAG;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1setERR
        (JNIEnv *env, jclass obj, jint canid) {
    return canid | CAN_ERR_FLAG;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1clearEFFSFF
        (JNIEnv *env, jclass obj, jint canid) {
    return canid & ~CAN_EFF_FLAG;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1clearRTR
        (JNIEnv *env, jclass obj, jint canid) {
    return canid & ~CAN_RTR_FLAG;
}

JNIEXPORT jint JNICALL Java_ru_test_testjni_CanSocket__1clearERR
        (JNIEnv *env, jclass obj, jint canid) {
    return canid & ~CAN_ERR_FLAG;
}
...
Java_ru_test_testjni_CanSocket__1setBitrate(JNIEnv *env, jclass clazz, jint bitrate) {
    sys("ip link set can0 down");
    char *bit = "ip link set can0 type can bitrate ";
    char *buf = new char[strlen(bit) + sizeof(bitrate) + 1];
    sprintf(buf, "%s%d", bit, bitrate);
    sys((const char *) buf);
    sys("ip link set can0 up");
}